...
class BinPickingPathFindingEnv(Env):
    ...
    def step(self, action):
        ...
        if self.simulator.task_completed():
            remaining_time_bonus = max(0, (self.time_limit - self.time_steps) * 3)  # Scaled efficiency bonus
            reward += 50.0 + remaining_time_bonus  # Reward for completing all tasks
